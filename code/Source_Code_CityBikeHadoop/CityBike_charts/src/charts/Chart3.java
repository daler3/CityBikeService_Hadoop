...
public class Chart3 extends ApplicationFrame {


    public Chart3(final String title, String path) {
    ...
    private CategoryDataset createDataset(String path) {
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null){
				...
				dataset.addValue(Integer.parseInt(valuesSplit[1]), series1, splitted[0]);	
			}
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "N. of trips per biker age range",         // chart title
 ...
 /*   
    public static void main(final String[] args) {
        ...
        final Chart3 nTripsBikerAgeRange = new Chart3("N. of trips per biker age range", args[0], args[1]);
