...
public class MainClass extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Path path7 = new Path(rootPath+inizioName+"07"+fineName);
		Path path8 = new Path(rootPath+inizioName+"08"+fineName);
		Path path9 = new Path(rootPath+inizioName+"09"+fineName);
		Path path10 = new Path(rootPath+inizioName+"10"+fineName);
		Path path11 = new Path(rootPath+inizioName+"11"+fineName);
		...
		FileInputFormat.setInputPaths(job1, path1, path2, path3, path4, path5, path6, path7, path8, path9, path10, path11);
        ...
        FileInputFormat.setInputPaths(job2, path1, path2, path3, path4, path5, path6, path7, path8, path9, path10, path11);
        ...
        FileInputFormat.setInputPaths(job3, path1, path2, path3, path4, path5, path6, path7, path8, path9, path10, path11);
        ...
        JobControl jobControl = new JobControl("job_control");
	...
	public static void main(String[] args) throws Exception {
		...
		System.setProperty("hadoop.home.dir", args[4]);
